...
#
# mcs4pynq_proj.tcl: Tcl script for re-creating project 'mcs4pynq'
#
# Generated by Vivado on Mon Aug 26 23:52:37 -0700 2019
...
#
# 1. This project restoration tcl script (mcs4pynq_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/admin/Documents/GitHub/mcs-4-pynq/vivado/mcs4pynq.srcs/sources_1/bd/mcs4pynq/mcs4pynq.bd"
#    "C:/Users/admin/Documents/GitHub/mcs-4-pynq/vivado/mcs4pynq.srcs/sources_1/bd/mcs4pynq/hdl/mcs4pynq_wrapper.v"
#    "C:/Users/admin/Documents/GitHub/mcs-4-pynq/vivado/pynq-z2_v1.0.xdc"
#
...
set script_file "mcs4pynq_proj.tcl"
...
set_property -name "board_part_repo_paths" -value "C:/Users/admin/AppData/Roaming/Xilinx/Vivado/2019.1/xhub/board_store" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/mcs4_1.0"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../rtl/mcs4_pkg.sv"] \
]
add_files -norecurse -fileset $obj $files

# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/mcs4pynq.srcs/sources_1/bd/mcs4pynq/mcs4pynq.bd" ]\
 [file normalize "${origin_dir}/mcs4pynq.srcs/sources_1/bd/mcs4pynq/hdl/mcs4pynq_wrapper.v" ]\
]
set added_files [add_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../rtl/mcs4_pkg.sv"
...
set file "hdl/mcs4pynq_wrapper.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "top" -value "mcs4pynq_wrapper" -objects $obj
...
set file "vivado/pynq-z2_v1.0.xdc"
